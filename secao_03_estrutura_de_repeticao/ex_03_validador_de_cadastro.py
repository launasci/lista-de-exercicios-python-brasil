...
def cadastrar_usuario(nome: str, idade: int, salario: float, sexo: str, estado_civil: str):
    ...
    if len(nome) >= 3 and (idade >= 0 or idade <=150) and (salario > 0) and (sexo == 'f' or sexo == 'm') and (estado_civil == 's' or estado_civil == 'c' or  estado_civil == 'v' or estado_civil =='d'):
      print('Cadastro realizado com sucesso')
    
    else:
      sexos = ('f', 'm')
      estado_civils = ('s', 'c', 'v', 'd')
      ...
      if estado_civil not in estado_civils:
